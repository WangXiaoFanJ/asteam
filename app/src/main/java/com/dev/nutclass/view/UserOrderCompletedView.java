 ...
 */
public class UserOrderCompletedView extends RelativeLayout {
    ...
    public UserOrderCompletedView(Context context) {
        super(context);
        mContext= context;
        initView();
    }

    public UserOrderCompletedView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext =context;
        initView();
    }
